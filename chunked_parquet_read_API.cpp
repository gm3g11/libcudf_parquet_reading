...
int main(int argc, char** argv)
{
    ...
    auto read_opts = cudf::io::parquet_reader_options::builder(cudf::io::source_info("../exp_lalor/dp.1m.none.parquet")).build();
    ...
    auto reader = cudf::io::chunked_parquet_reader(0,0,read_opts, cudf::get_default_stream(),mr);
    int chunk_count = 0;
